...
import { AnimatedFrame } from '../frames/AnimatedFrames';
  ...
  return (
    <div
      className={cn(
        ...
        "border-t-2 border-b-2 border-purple-500/40",
        "royal-name-bar touch-pan-x touch-manipulation",
        className
      )}
    ...
    >
      ...
      <div
        ref={scrollRef}
        className={cn(
          "flex items-center gap-3 sm:gap-6 px-3 sm:px-6 py-2 sm:py-4 overflow-x-auto scrollbar-hide",
          "will-change-scroll touch-pan-x",
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                {user.frameConfig || user.selectedFrame ? (
                  <AnimatedFrame 
                    frameConfig={user.frameConfig || user.selectedFrame} 
                    size="small"
                  >
                    <Avatar className="w-10 h-10 border-2 border-transparent relative z-10">
              ...
              <div className="relative">
                ...
                {isPremium && (
                  <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2">
                    <div className="flex items-center gap-1 px-2 py-0.5 rounded-full bg-gradient-to-r from-yellow-500/60 to-amber-500/60 border border-yellow-400/70">
